...
namespace moodboardwebapi
{
    public class Startup
    {
        private readonly string connString = "Server=localhost; Uid=root; Database=moodboard; Pwd=root;";
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            using (var context = scope.ServiceProvider.GetService<MbContext>())
            {
